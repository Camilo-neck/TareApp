...
class app():
    ...
    def merge_opc(self):
        #INPUT - OUTPUT NAME, BTTN+ PDFS - LISTA PATHS
    ...
    def insert_opc(self):
        #INPUT - OUTPUT NAME, BTTN+ + PDF1.2, DESPLEGABLE PAG1.2
    ...
    def swap_opc(self):
        #BTTN+ - PDF, INPUT - OUTPUT NAME, DESPLEGABLES PAG1.2
